                ...
                @foreach($eq_webcams as $webcams)
                    <tr class="even:bg-gray-300 odd:bg-white">
                        ...
                        <td class=" px-3 py-3 ">
                            <div class="mb-2">
                                <button type="submit"
                                        class="px-1 py-1 mr-3 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 EditWebcam">
                                    ویرایش
                                </button>
                            </div>
                            <div>
                                <button type="submit" data-type="webcam" data-id="{{ $webcams->id }}"
