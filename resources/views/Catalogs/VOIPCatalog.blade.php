    ...
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            ...
            <div class="bg-white rounded shadow p-6 flex flex-col ">
                <button id="new-VOIP-button" type="button"
                ...
                <form id="new-VOIP">
                    ...
                    <div class="mb-4 flex items-center">
                        <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="newVOIPModal">
                            <div
                                ...
                                <div
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select id="brand" class="border rounded-md w-full px-3 py-2"
                                                    ...
                                                    @php
                                                        ...
                                                        where('name','!=','ONBOARD')
                                                        ->whereJsonContains('products', ['VOIP'])
                                                        ->orderBy('name')->get();
                                                    @endphp
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        ...
                                        <button id="cancel-new-VOIP" type="button"
                ...
                <form id="edit-VOIP">
                    @csrf
                    <div class="mb-4 flex items-center">
                        <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="editVOIPModal">
                            <div
                                class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center  sm:block sm:p-0">
                                <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                                ...
                                <div
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        <input type="hidden" name="VOIP_id" id="VOIP_id" value="">
                                        <button type="submit"
                                                class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-blue-300">
                                            ویرایش
                                        </button>
                                        <button id="cancel-edit-VOIP" type="button"
                                                class="mt-3 w-full inline-flex justify-center px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-blue-300 sm:mt-0 sm:w-auto">
                                            انصراف
                                        </button>
                                    </div>
                ...
                <table class="w-full border-collapse rounded-lg overflow-hidden text-center datasheet">
                    ...
                    @foreach ($VOIPList as $VOIP)
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4">
                                @php
                                    $VOIPInfo=\App\Models\Catalogs\Company::find($VOIP->company_id)
                                @endphp
                                {{ $VOIPInfo->name }}</td>
                            <td class="px-6 py-4">{{ $VOIP->model }}</td>
                            <td class="px-6 py-4">
                                <button type="submit" data-id="{{ $VOIP->id }}"
                                        class="px-4 py-2 mr-3 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 VOIPControl">
                                    جزئیات و ویرایش
                                </button>
                                @if($VOIP->active==1)
                                    <button type="submit" data-id="{{ $VOIP->id }}"
                                            class="px-4 py-2 mr-3 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 deactiveVOIPControl">
                                        غیرفعالسازی
                                    </button>
                                @else
                                    <button type="submit" data-id="{{ $VOIP->id }}"
                                            class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300 deactiveVOIPControl">
                                        فعالسازی
                                    </button>
                                @endif
                            </td>
