                    ...
                    @foreach ($assistanceList as $assistance)
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @if($assistance->active==1)
                                    <button type="submit" data-id="{{ $assistance->id }}"
                                            class="px-4 py-2 mr-3 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 deactiveAssistanceControl">
                                        غیرفعالسازی
                                    </button>
                                @else
                                    <button type="submit" data-id="{{ $assistance->id }}"
                                            class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300 deactiveAssistanceControl">
                                        فعالسازی
                                    </button>
                                @endif
                            </td>
