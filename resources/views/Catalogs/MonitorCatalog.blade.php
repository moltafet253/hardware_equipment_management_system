                    ...
                    @foreach ($monitorList as $monitor)
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @if($monitor->active==1)
                                    <button type="submit" data-id="{{ $monitor->id }}"
                                            class="px-4 py-2 mr-3 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 deactiveMonitorControl">
                                        غیرفعالسازی
                                    </button>
                                @else
                                    <button type="submit" data-id="{{ $monitor->id }}"
                                            class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300 deactiveMonitorControl">
                                        فعالسازی
                                    </button>
                                @endif
                            </td>
