    ...
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            ...
            <div class="bg-white rounded shadow p-6 flex flex-col ">
                <button id="new-scanner-button" type="button"
                ...
                <form id="new-scanner">
                    ...
                    <div class="mb-4 flex items-center">
                        <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="newScannerModal">
                            <div
                                ...
                                <div
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select id="brand" class="border rounded-md w-full px-3 py-2"
                                                    ...
                                                    @php
                                                        ...
                                                        where('name','!=','ONBOARD')
                                                        ->whereJsonContains('products', ['Scanner'])
                                                        ->orderBy('name')->get();
                                                    @endphp
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        ...
                                        <button id="cancel-new-scanner" type="button"
                        ...
                        <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="editScannerModal">
                            <div
                                ...
                                <div
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        <input type="hidden" name="scanner_id" id="scanner_id" value="">
                                        <button type="submit"
                                                class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-blue-300">
                                            ویرایش
                                        </button>
                                        <button id="cancel-edit-scanner" type="button"
                                                class="mt-3 w-full inline-flex justify-center px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-blue-300 sm:mt-0 sm:w-auto">
                                            انصراف
                                        </button>
                                    </div>
                ...
                <table class="w-full border-collapse rounded-lg overflow-hidden text-center datasheet">
                    ...
                    @foreach ($scannerList as $scanner)
                        <tr class="bg-white">
                            <td class="px-6 py-4">{{ $loop->iteration }}</td>
                            <td class="px-6 py-4">
                                @php
                                    $scannerInfo=\App\Models\Catalogs\Company::find($scanner->company_id)
                                @endphp
                                {{ $scannerInfo->name }}</td>
                            <td class="px-6 py-4">{{ $scanner->model }}</td>
                            <td class="px-6 py-4">
                                <button type="submit" data-id="{{ $scanner->id }}"
                                        class="px-4 py-2 mr-3 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 ScannerControl">
                                    جزئیات و ویرایش
                                </button>
                                @if($scanner->active==1)
                                    <button type="submit" data-id="{{ $scanner->id }}"
                                            class="px-4 py-2 mr-3 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 deactiveScannerControl">
                                        غیرفعالسازی
                                    </button>
                                @else
                                    <button type="submit" data-id="{{ $scanner->id }}"
                                            class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300 deactiveScannerControl">
                                        فعالسازی
                                    </button>
                                @endif
                            </td>
