...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">تعاریف اولیه - مدیریت بر اطلاعات اسپیکر</h1>

            <div class="bg-white rounded shadow p-6 flex flex-col ">
                <button id="new-speaker-button" type="button"
                ...
                <form id="new-speaker">
                    ...
                    <div class="mb-4 flex items-center">
                        <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="newSpeakerModal">
                            <div
                                ...
                                <div
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select id="brand" class="border rounded-md w-full px-3 py-2"
                                                    ...
                                                    @php
                                                        ...
                                                        where('name','!=','ONBOARD')
                                                        ->whereJsonContains('products', ['Speaker'])
                                                        ->orderBy('name')->get();
                                                    @endphp
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        ...
                                        <button id="cancel-new-speaker" type="button"
                ...
                <form id="edit-speaker">
                    @csrf
                    <div class="mb-4 flex items-center">
                        <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="editSpeakerModal">
                            <div
                                class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center  sm:block sm:p-0">
                                <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                                ...
                                <div
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        ...
                                        <button id="cancel-edit-speaker" type="button"
                                                class="mt-3 w-full inline-flex justify-center px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-blue-300 sm:mt-0 sm:w-auto">
                                            انصراف
                                        </button>
                                    </div>
                ...
                <table class="w-full border-collapse rounded-lg overflow-hidden text-center datasheet">
                    ...
                    @foreach ($speakerList as $speaker)
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4">
                                @php
                                    $speakerInfo=\App\Models\Catalogs\Company::find($speaker->company_id)
                                @endphp
                                {{ $speakerInfo->name }}</td>
                            <td class="px-6 py-4">{{ $speaker->model }}</td>
                            <td class="px-6 py-4">
                                <button type="submit" data-id="{{ $speaker->id }}"
                                        class="px-4 py-2 mr-3 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 SpeakerControl">
                                    جزئیات و ویرایش
                                </button>
                                @if($speaker->active==1)
                                    <button type="submit" data-id="{{ $speaker->id }}"
                                            class="px-4 py-2 mr-3 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 deactiveSpeakerControl">
                                        غیرفعالسازی
                                    </button>
                                @else
                                    <button type="submit" data-id="{{ $speaker->id }}"
                                            class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300 deactiveSpeakerControl">
                                        فعالسازی
                                    </button>
                                @endif
                            </td>
