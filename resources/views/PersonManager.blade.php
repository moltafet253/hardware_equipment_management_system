                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="flex flex-col mb-4">
                                                <label for="personnel_code"
                                                       class="block text-gray-700 text-sm font-bold mb-2">کد پرسنلی*:</label>
                                            ...
                                            <div class="flex flex-col mb-4">
                                                <label for="phone"
                                                       class="block text-gray-700 text-sm font-bold mb-2">شماره داخلی:</label>
                                            ...
                                            <div class="flex flex-col mb-4">
                                                <label for="net_username"
                                                       class="block text-gray-700 text-sm font-bold mb-2">یوزر شبکه:</label>
                                            ...
                                            <div class="flex flex-col mb-4">
                                                <label for="room_number"
                                                       class="block text-gray-700 text-sm font-bold mb-2">شماره اتاق:</label>
                                        ...
                                        <div class="mt-4">
                                            <div class="flex flex-col items-right mb-2">
                                                <label for="nameForEdit"
                                                       class="block text-gray-700 text-sm font-bold mb-2">نام*:</label>
                                                <input type="text" id="nameForEdit" name="nameForEdit" autocomplete="off"
                                                       class="border rounded-md w-full mb-4 px-3 py-2 text-right"
                                                       placeholder="نام پرسنل را وارد کنید">
                                                <label for="familyForEdit"
                                                       class="block text-gray-700 text-sm font-bold mb-2">نام
                                                    خانوادگی*:</label>
                                                <input type="text" id="familyForEdit" name="familyForEdit" autocomplete="off"
                                                       class="border rounded-md w-full mb-2 px-3 py-2 text-right"
                                                       placeholder="نام خانوادگی پرسنل را وارد کنید">
                                            </div>
                                            <div class="flex flex-col mb-4">
                                                <label for="personnel_codeForEdit"
                                                       class="block text-gray-700 text-sm font-bold mb-2">کد پرسنلی*:</label>
                                                <input type="text" disabled name="personnel_codeForEdit" id="personnel_codeForEdit"
                                            ...
                                            <div class="mb-4">
                                                <label for="assistanceForEdit"
                                                       class="block text-gray-700 text-sm font-bold mb-2">معاونت/بخش:</label>
                                                <select id="assistanceForEdit" class="border rounded-md w-full px-3 py-2"
