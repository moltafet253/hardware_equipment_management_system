...
VALUES
    (70, 'DCP 8065DN', 'چند کاره'),
    (71, 'i-sensys MF4570DN', 'چند کاره'),
    (71, 'i-sensys MF4350D', 'چند کاره'),
    (71, 'i-sensys FAX-L150', 'چند کاره'),
    (71, 'i-sesnys MF4550D', 'چند کاره'),
    (71, 'MFC-L2700DW', 'چند کاره'),
    (18, '1536DNF MFP', 'چند کاره'),
    (18, 'Pro M1132 MFP', 'چند کاره'),
    (18, 'M1214NFH MFP', 'چند کاره'),
    (18, 'M1522NF', 'چند کاره'),
    (43, 'SCX-3405FH', 'چند کاره'),
    (43, 'SCX-4833FD', 'چند کاره'),
    (43, 'SCX-5637FR', 'چند کاره');
";
        DB::statement($query);
